function journey(){
    ...
    javaContent.innerHTML = ("<img src = ./journey.png> <div id ='newCont'><h3>this quick slideshow displays by age what to pursue and what to watch out for on your journey to financial independence</h3></div>");
